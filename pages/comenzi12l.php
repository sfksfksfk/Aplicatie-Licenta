      ...
      <div class="row">
        ...
        <div> &nbsp</div>
                ...
                <div class="row justify-content-center">
                      ...
                      <div class="col-3 w-20">
                          <a class="btn bg-gradient-primary mt-0 w-100" href="comenzi12l.php">Ultimele 12 luni</a>
                      </div>
                ...
                <table class="table align-items-center justify-content-center mb-0">
                  ...
                  <?php             
                    $sql="SELECT comenzi.*, clienti.nume 
                            ...
                            WHERE comenzi.data_ex >= DATE_SUB(CURDATE(), INTERVAL 12 MONTH)
