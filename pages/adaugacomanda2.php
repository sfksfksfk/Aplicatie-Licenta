  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "INSERT INTO comenzi (idcomanda, id_client, oras, stradanr, data_ex) 
            VALUES ($newOrderId, $clientId, '$oras', '$strnr', '$dataex')";
            ...
            echo '<a href="comenzi.php">Foloseste acest link pentru a te intoarce </a>';  
        }
